...
part of 'api_drink_detail.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

APIDrinkDetail _$APIDrinkDetailFromJson(Map<String, dynamic> json) =>
    APIDrinkDetail(
      drinks: (json['drinks'] as List<dynamic>)
          .map((e) => APIDrinkDetailElement.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$APIDrinkDetailToJson(APIDrinkDetail instance) =>
    <String, dynamic>{
      'drinks': instance.drinks,
    };

APIDrinkDetailElement _$APIDrinkDetailElementFromJson(
        Map<String, dynamic> json) =>
    APIDrinkDetailElement(
...
Map<String, dynamic> _$APIDrinkDetailElementToJson(
        APIDrinkDetailElement instance) =>
    <String, dynamic>{
